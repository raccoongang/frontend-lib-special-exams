...
let EntranceProctoredExamInstructions = ({ startExam }) => (
  <div>
    <Container className="border py-5 mb-4">
      ...
      <p className="mt-4 pl-md-4">
        <Button data-testid="start-exam-without-proctoring-button"
    ...
    <div className="footer-sequence">
      <p>
        <Button data-testid="request-exam-time-button"
                variant="link"
                onClick={()=>{}}
        >
          <FormattedMessage
...
EntranceProctoredExamInstructions = withExamStore(
  EntranceProctoredExamInstructions, mapExamStateToProps, { startExam }
);
...
export { EntranceProctoredExamInstructions };
